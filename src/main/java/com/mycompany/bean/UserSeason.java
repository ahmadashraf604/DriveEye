...
@NamedQueries({
    ...
    , @NamedQuery(name = "UserSeason.getUserSeasonScore", query = "SELECT u FROM UserSeason u WHERE u.userSeasonPK.userId = :userId and u.userSeasonPK.seasonId = (SELECT MAX(us.userSeasonPK.seasonId) from UserSeason us)")
